...
C
C   USAGE
C     QSORT(N,DATA,INDEX)
C
C   INPUTS
C     N     - INTEGER
C     DATA  - REAL array of data
C     INDEX - INTEGER array
C
C   SIDE EFFECTS
...
C
C   NOTE
C     QSORT uses a hybrid QuickSort algorithm, based on several
