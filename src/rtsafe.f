...
C
C   NAME
C     RTSAFE - root finding
C
C   DESCRIPTION
C     Combination of Newton-Raphson and bisection methods to find the
C     root of a function bracketed between X1 and X2.
C
C   USAGE
C     CALL RTSAFE(FUNCD, X1, X2, XACC)
C
C   INPUTS
